...
app = FastAPI(title="Anschreiben Generator", description="AI-powered cover letter generation service")
...
async def upload_resume(file: UploadFile = File(...)):
    ...
    try:
        ...
        if filename.endswith('.pdf'):
            ...
            raise HTTPException(status_code=400, detail="DOC files are not supported. Please convert to DOCX or PDF format.")
        else:
            # Handle text files
            try:
                ...
                try:
                    ...
                    raise HTTPException(status_code=400, detail="Unable to decode file. Please upload a text, PDF, or DOCX file.")
